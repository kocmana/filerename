...
| `IMAGE_\<<R\|[0-9]\{3}>>.jpg` | `\<<R>>-picture.JPG` | `IMAGE_001.jpg` | `001-picture.JPG`
|===
...
| `img\<<TS\|ddMMyyyyHHmmssSSS>>.jpg` | `image\<<TS\|yyyy-MM-dd_HHmmss>>.jpg` | `img20122021125401451.jpg` | `image2021-12-20_125401.jpg`
|===
...
| `file\<<R\|[0-9]\{5}>>.png` | `image_\<<CD\|yyyy-MM-dd_HHmmss>>.png` | `file00019.png` | `image_2021-12-20_125401.png`
|===
...
| `birthday_\<<R\|(.+)>>.png` | `image_\<<E\|%02d>>.png` | `birthday_1999-12-7-127.png` | `image_01.png`
| `birthday_\<<R\|(.+)>>.png` | `image_\<<E>>.png` | `birthday_1999-12-7-127.png` | `image_1.png`
|===
